...
from booking_project.utils.filter_by_query_params import PlacementFilter
...
class MyPlacementsListView(ListAPIView):
    ...
    def get_queryset(self):
        ...
        queryset = Placement.objects.filter(owner=user)
...
class InactivePlacementListView(ListAPIView):
    ...
    def get_queryset(self):
        ...
        queryset = Placement.inactive_objects.filter(owner=user)
