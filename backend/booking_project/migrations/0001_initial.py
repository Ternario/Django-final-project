# Generated by Django 5.1.1 on 2025-02-16 16:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(max_length=2000, validators=[django.core.validators.MinLengthValidator(40)], verbose_name='Apartments description')),
                ...
                ('number_of_beds', models.PositiveIntegerField(default=1, validators=[django.core.validators.MaxValueValidator(10), django.core.validators.MinValueValidator(1)], verbose_name='Number of beds')),
                ('single_bed', models.IntegerField(default=1, validators=[django.core.validators.MaxValueValidator(15), django.core.validators.MinValueValidator(0)], verbose_name='Number of single bed')),
                ('double_bed', models.IntegerField(default=0, validators=[django.core.validators.MaxValueValidator(15), django.core.validators.MinValueValidator(0)], verbose_name='Number of double bed')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('placement_image', models.ImageField(blank=True, null=True, upload_to=booking_project.models.placement_image.PlacementImage.upload_to, verbose_name='Placement images')),
                ('placement', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='placement_images', to='booking_project.placement')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
