# Generated by Django 5.1.1 on 2025-04-08 10:18
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('check_in_date', models.DateField(verbose_name='Start date')),
                ('check_out_date', models.DateField(verbose_name='End date')),
                ('check_in_time', models.TimeField(blank=True, choices=[('value', 'label'), ('value', 'label'), ('value', 'label'), ('value', 'label'), ('value', 'label'), ('value', 'label'), ('value', 'label'), ('value', 'label'), ('value', 'label'), ('value', 'label'), ('value', 'label'), ('value', 'label')], default=datetime.time(11, 0), verbose_name='Check-in Time')),
                ('check_out_time', models.TimeField(blank=True, choices=[('value', 'label'), ('value', 'label'), ('value', 'label'), ('value', 'label'), ('value', 'label'), ('value', 'label'), ('value', 'label'), ('value', 'label'), ('value', 'label'), ('value', 'label'), ('value', 'label')], default=datetime.time(10, 0), verbose_name='Check-out Time')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('booking', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='Booking', to='booking_project.booking', verbose_name='Previous Booking')),
