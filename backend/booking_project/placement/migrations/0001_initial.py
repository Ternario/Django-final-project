    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.FloatField(null=True, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(5)], verbose_name='rating 1-5')),
                ...
                ('location', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='placement.location')),
            ],
            options={
                'ordering': ['-created_at'],
            },
