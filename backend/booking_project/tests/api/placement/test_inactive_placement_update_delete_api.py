...
class InactivePlacementRetrieveUpdateDeleteTest(PlacementSetup):
    def test_user_owner_can_retrieve_full_info_about_inactive_placement(self):
        ...
        self.assertEqual(response.data["placement_image"][0]["placement"], self.inactive_placement.pk)
        self.assertEqual(len(response.data["placement_image"]), len(self.inactive_placement_images))
    ...
    def test_user_owner_can_delete_inactive_placement(self):
        ...
        self.assertFalse(PlacementDetails.objects.filter(placement=self.inactive_placement.pk))
        self.assertFalse(PlacementLocation.objects.filter(placement=self.inactive_placement.pk))
    ...
    def test_unauthorized_owner_user_cannot_delete_inactive_placement(self):
        ...
        self.assertEqual(PlacementImage.objects.filter(placement=self.inactive_placement.pk).count(), 8)
        self.assertTrue(PlacementDetails.objects.get(placement=self.inactive_placement.pk))
        self.assertTrue(PlacementLocation.objects.get(placement=self.inactive_placement.pk))
