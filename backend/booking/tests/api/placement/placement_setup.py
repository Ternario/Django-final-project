...
from booking.models import Placement, PlacementDetails, PlacementImage, PlacementLocation
from booking.tests.api.base_setup_data.users_setup_data import BaseUsersSetupData
