...
from booking.tests.api.booking.booking_setup import BookingSetup
...
class BookingCreateTest(BookingSetup):
    def test_landlord_can_create_new_booking(self):
        ...
        Sends a Post request with booking data and expects a 201 CREATED response.
        Verifies that booking count increases and new booking has the correct link to landlord user and placement.
        """
    ...
    def test_regular_user_can_create_new_booking(self):
        ...
        Sends a Post request with booking data and expects a 201 CREATED response.
        Verifies that booking count increases and new booking has the correct link to user and placement.
        """
    ...
    def test_landlord_cannot_create_new_booking_to_his_own_apartment(self):
        ...
        Sends a Post request with booking data and expects a 400 BAD REQUEST response.
        Verifies that booking count has not increased.
        """
        ...
        self.assertEqual(response.data["user"][0], "You can't booking your own apartment.")
    ...
    def test_user_cannot_create_new_booking_with_empty_fields(self):
        ...
        Sends a Post request with empty booking fields and expects a 400 BAD REQUEST response.
        Verifies that booking count has not increased.
        """
    ...
    def test_unauthenticated_user_cannot_create_new_booking(self):
        ...
        Sends a Post request with booking data and expects a 401 UNAUTHORIZED response.
        Verifies that booking count has not increased.
        """
