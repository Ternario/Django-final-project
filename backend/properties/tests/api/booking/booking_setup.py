...
from properties.models import Booking, Placement
...
from properties.tests.api.base_setup_data.users_setup_data import BaseUsersSetupData
...
class BookingSetup(BaseUsersSetupData):
    ...
    def setUpTestData(cls):
        ...
        cls.placement = Placement.objects.create(
            ...
            title="First Hotel by Landlord User2 for properties",
            description="A" * 50,
            price=250,
            number_of_rooms=2,
            placement_area=43.5,
        ...
        cls.placement2 = Placement.objects.create(
            ...
            title="First Hostel by Landlord User for properties",
        ...
        cls.placement3 = Placement.objects.create(
            owner=cls.landlord_user2,
            category=cls.hotel_category,
            title="Second Hotel by Landlord User2 for properties",
            description="A" * 50,
            price=250,
            number_of_rooms=2,
            placement_area=43.5,
        ...
        cls.booking_choices_url = reverse("properties-time-choices")
        cls.booking_create_url = reverse("properties-create")
        cls.booking_placement_owner_list_url = reverse("properties-placement-owner-list")
        cls.booking_owner_list_url = reverse("properties-owner-list")
        cls.booking_placement_owner_retrieve_update = lambda pk: reverse("properties-placement-owner-update",
                                                                         kwargs={"pk": pk})
        cls.booking_owner_retrieve_update = lambda pk: reverse("properties-owner-update", kwargs={"pk": pk})
        cls.inactive_booking_placement_owner_list = reverse("properties-placement-owner-inactive")
        cls.inactive_booking_owner_list = reverse("properties-owner-inactive")
