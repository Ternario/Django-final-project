...
from properties.models import Placement, PlacementImage
...
class PlacementActivationTest(PlacementSetup):
    def test_user_owner_can_deactivate_placement(self):
        ...
        self.assertEqual(Placement.active_objects.count(), 0)
        self.assertTrue(Placement.inactive_objects.get(pk=self.placement.pk))
    ...
    def test_user_owner_can_activate_placement(self):
        ...
        self.assertTrue(Placement.active_objects.get(pk=self.inactive_placement.pk))
    ...
    def test_user_owner_cannot_activate_placement_without_images(self):
        ...
        self.assertEqual(Placement.active_objects.count(), 1)
        self.assertTrue(Placement.inactive_objects.get(pk=self.inactive_placement.pk))
    ...
    def test_unauthorized_user_owner_cannot_deactivate_placement(self):
        ...
        self.assertEqual(Placement.active_objects.count(), 1)
        self.assertTrue(Placement.active_objects.get(pk=self.placement.pk))
