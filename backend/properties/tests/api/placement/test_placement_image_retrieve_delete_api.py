...
class PlacementDetailsRetrieveUpdateTest(PlacementSetup):
    def test_user_owner_can_retrieve_images(self):
        ...
        placement_image = PlacementImage.related_objects.filter(placement=self.placement.pk)
    ...
    def test_user_owner_can_retrieve_images_from_inactive_placement(self):
        ...
        placement_image = PlacementImage.related_objects.filter(placement=self.inactive_placement.pk)
    ...
    def test_user_owner_can_add_images(self):
        ...
        self.assertEqual(PlacementImage.related_objects.filter(placement=self.placement.pk).count(), 15)
    ...
    def test_user_owner_can_add_images_to_inactive_placement(self):
        ...
        self.assertEqual(response.status_code, status.HTTP_201_CREATED)
        self.assertEqual(PlacementImage.related_objects.filter(placement=self.inactive_placement.pk).count(), 15)
    ...
    def test_user_owner_cannot_add_too_many_images(self):
        ...
        self.assertEqual(len(self.placement_images),
                         PlacementImage.related_objects.filter(placement=self.placement.pk).count())
    ...
    def test_user_owner_cannot_add_too_heavy_image(self):
        ...
        self.assertEqual(PlacementImage.related_objects.filter(placement=self.placement.pk).count(),
                         len(self.placement_images))
    ...
    def test_user_owner_can_delete_images(self):
        ...
        image_data = {
            "image_list": [image.pk for image in PlacementImage.related_objects.filter(placement=self.placement.pk)]
        }
    ...
    def test_user_owner_can_delete_images_in_inactive_placement(self):
        ...
        image_data = {
            "image_list": [image.pk for image in
                           PlacementImage.related_objects.filter(placement=self.inactive_placement.pk)]
        }
    ...
    def test_another_landlord_user_cannot_retrieve_images(self):
        ...
        Sends a GET request and expects 404 NOT FOUND response.
        Verifies that the user receive the correct answer.
        """
        ...
        self.assertEqual(response.data["detail"], "No matching images found.")
    ...
    def test_another_landlord_user_cannot_delete_images(self):
        ...
        Sends a DELETE request and expects 404 NOT FOUND response.
        Verifies that the Placement Images have not been deleted and user receive the correct answer.
        """
